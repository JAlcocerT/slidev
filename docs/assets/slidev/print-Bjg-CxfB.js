import{d as p,ag as u,y as h,o as s,b as n,e as t,x as a,A as r,F as f,ad as g,a6 as v,l as x,g as b}from"../modules/vue-DHFwCr14.js";import{a as y,u as N,y as m}from"../index-BflUNa49.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-QkL39MWT.js";import"../modules/shiki-DV62XDDs.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},A={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),D={key:0,class:"border-main mb-8"},E=p({__name:"print",setup(F){const{slides:_,total:d}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
